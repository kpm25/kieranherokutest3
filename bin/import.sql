...
insert into user (username,enabled,password,role_id) values ('kpm25',true,'$2a$06$wu2iwXLwCJq4NmAF5AFRi.UgaJ.Ui8zaSWzPTbaLDBI5il3rPOSl2',1);
...
insert into task (complete,description, user_id) values (true,'Kierans Security',3);
insert into task (complete,description, user_id) values (false,'Kierans application',3);
